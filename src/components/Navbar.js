              ...
              <li className="nav-item basis-3/5">
                <form className="flex items-center">
                  ...
                  <div className="relative w-full">
                    ...
                    <input
                      type="text"
                      className="w- border text-[#A9B0B9] text-xl rounded-lg pl-10 p-3"
                  ...
                  <button
                    type="submit"
                    className="inline-flex uppercase items-center py-3 px-4 ml-5 text-xl font-medium text-white bg-[#051D4C] rounded-lg hover:bg-blue-900"
                  >
                    Search
                  </button>
                </form>
